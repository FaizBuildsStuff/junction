...
const stackServices = [
  { id: "openai", name: "OpenAI", icon: Cpu, placeholder: "sk-proj-..." },
  { id: "anthropic", name: "Anthropic", icon: ShieldCheck, placeholder: "sk-ant-..." },
  { id: "aws", name: "AWS Cloud", icon: Cloud, placeholder: "Access Key ID" },
  { id: "gcp", name: "Google Cloud", icon: Globe, placeholder: "Project ID" },
  { id: "azure", name: "Azure", icon: Database, placeholder: "Subscription ID" },
  { id: "vercel", name: "Vercel", icon: Zap, placeholder: "Auth Token" },
  { id: "stripe", name: "Stripe", icon: CreditCard, placeholder: "sk_live_..." },
  { id: "supabase", name: "Supabase", icon: Database, placeholder: "Anon Key" },
  { id: "mongodb", name: "MongoDB Atlas", icon: Database, placeholder: "API Key" },
  { id: "twillio", name: "Twilio", icon: Mail, placeholder: "Account SID" },
  { id: "posthog", name: "PostHog", icon: Zap, placeholder: "Project API Key" },
  { id: "clerk", name: "Clerk", icon: Lock, placeholder: "Secret Key" },
  { id: "neon", name: "Neon DB", icon: Database, placeholder: "Connection String" },
  { id: "resend", name: "Resend", icon: Mail, placeholder: "re_..." },
  { id: "github", name: "GitHub Actions", icon: Github, placeholder: "Personal Access Token" },
  { id: "linear", name: "Linear", icon: CheckCircle2, placeholder: "API Key" },
  { id: "slack", name: "Slack API", icon: Mail, placeholder: "Bot User Token" },
  { id: "pinecone", name: "Pinecone", icon: Cpu, placeholder: "API Key" },
  { id: "planetscale", name: "PlanetScale", icon: Database, placeholder: "Service Token" },
  { id: "render", name: "Render", icon: Cloud, placeholder: "API Key" },
  { id: "digitalocean", name: "DigitalOcean", icon: Cloud, placeholder: "Personal Access Token" },
  { id: "sentry", name: "Sentry", icon: ShieldCheck, placeholder: "Auth Token" },
  { id: "datadog", name: "DataDog", icon: Terminal, placeholder: "API Key" },
  { id: "cloudinary", name: "Cloudinary", icon: Layers, placeholder: "Cloud Name" },
  { id: "auth0", name: "Auth0", icon: Lock, placeholder: "Client Secret" },
  { id: "algolia", name: "Algolia", icon: Search, placeholder: "Admin API Key" },
];
    ...
    <main ref={containerRef} className="relative min-h-screen flex flex-col lg:flex-row bg-white selection:bg-[#C8F064] font-satoshi overflow-x-hidden">
      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-between p-6 md:p-12 lg:p-16 z-20 bg-white border-r border-[#162C25]/5">
        ...
        <div className="flex justify-between items-center reveal-node mb-8">
            ...
            <Link href="/login" className="text-[10px] font-black uppercase tracking-widest text-[#162C25]/40 border-b border-transparent hover:border-[#162C25] transition-all">
        ...
        <div className="max-w-xl w-full mx-auto flex-1 flex flex-col justify-center">
          ...
          <div className="space-y-4 mb-8">
             <div className="reveal-node grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <Input placeholder="aka_faiz" className="h-12 pl-10 rounded-xl bg-[#F2F9F1] border-none font-bold text-[#162C25]" />
                    </div>
                </div>
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <Input placeholder="rehman@agency.ai" className="h-12 pl-10 rounded-xl bg-[#F2F9F1] border-none font-bold text-[#162C25]" />
                    </div>
                </div>
             </div>
             ...
             <div className="reveal-node space-y-1.5">
                ...
                <div className="relative">
                    ...
                    <Input type="password" placeholder="••••••••••••" className="h-12 pl-10 rounded-xl bg-[#F2F9F1] border-none font-bold text-[#162C25]" />
                </div>
             </div>
          </div>
          ...
          <div className="reveal-node mb-8">
            ...
            {/* Scrollable list with fixed height so button shows */}
              ...
              {filteredServices.map((service) => {
                ...
                return (
                  <div key={service.id} className={`border rounded-xl transition-all duration-300 ${isOpen ? "border-[#C8F064] bg-[#F2F9F1]/50" : "border-[#162C25]/5 bg-white"}`}>
                    <button onClick={() => setExpandedService(isOpen ? null : service.id)} className="w-full flex items-center justify-between p-3 text-left">
                    ...
                    {isOpen && (
                      <div className="px-3 pb-3 animate-in fade-in slide-in-from-top-1">
                        <Input placeholder={service.placeholder} className="h-9 bg-white border-[#162C25]/10 text-[10px] font-mono rounded-lg" />
                      </div>
                    )}
                  </div>
                );
          ...
          <div className="reveal-node">
             <Button className="w-full bg-[#162C25] text-[#C8F064] h-14 rounded-2xl font-black uppercase tracking-[0.2em] hover:bg-[#1d332c] transition-all flex justify-between px-10 group shadow-xl">
